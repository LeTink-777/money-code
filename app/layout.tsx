...
// Space Mono has no Cyrillic subset — JetBrains Mono carries the Russian text at the same monospace width.
const displayFont = Space_Mono({ variable: "--ff-display", subsets: ["latin"], weight: ["400", "700"], display: "swap" });
const bodyFont = JetBrains_Mono({ variable: "--ff-body", subsets: ["latin", "cyrillic"], display: "swap" });
...
export const metadata: Metadata = {
  ...
  category: "денежный код по дате рождения",
};
